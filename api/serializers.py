...
class TransactionSerializer(serializers.ModelSerializer):
    class Meta:
        model = Transaction
        fields = ["id", "user", "budget", "amount", "label", "date"]
...
class ExpenseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Expense
        fields = ["id", "profile", "label", "amount"]


class BudgetCreateUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Budget
        fields = ["id", "profile", "label", "category", "balance", "amount"]
...
class TransactionCreateUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Transaction
        fields = ["user", "budget", "amount", "label", "date"]
